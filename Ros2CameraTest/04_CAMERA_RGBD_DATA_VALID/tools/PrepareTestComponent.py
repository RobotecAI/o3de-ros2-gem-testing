...
if __name__ == "__main__":
    ...
    # path = "Sensor configuration|Publishers|Color Camera Info|[0]"
    # out = editor.EditorComponentAPIBus(bus.Broadcast, "GetComponentProperty", cameraComponentId, path)
    # print (out.GetValue())


    # out = editor.EditorComponentAPIBus(bus.Broadcast, "BuildComponentPropertyList", cameraComponentId)
    # print(out)

    out = editor.EditorComponentAPIBus(bus.Broadcast, "GetComponentProperty", cameraComponentId, "Sensor configuration|Publishers|Color Image|[1]|Topic")
    print(out.GetValue())

    path = "Sensor configuration|Publishers|Color Image|[1]|Topic"
    editor.EditorComponentAPIBus(bus.Broadcast, "SetComponentProperty", cameraComponentId, path, out.GetValue())
